  ...
  return false;
    ...
    $(window).scroll(function() {
        ...
        if ($(this).scrollTop() > el.offset().top - 800) {
            ...
            script.src = "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Aff33592786caac6d4815c88a48b802b9d1fa327f2861f76882a17855760ce22e&amp;width=auto;25&amp;height=auto;lang=ru_RU&amp;scroll=false";
            el.append(script);
        };
    });
    //
...
$('a[href*="#control"]').click(function() {
  $page.animate({
      scrollTop: $($.attr(this, 'href')).offset().top
  }, 700);
  return false;
});
$('a[href*="#comand"]').click(function() {
  $page.animate({
      scrollTop: $($.attr(this, 'href')).offset().top
  }, 700);
  return false;
...
var isAddedMap = false;
    ...
    $(window).scroll(function() {
        ...
        if ($(this).scrollTop() > el.offset().top - 800) {
            ...
            isAddedMap = true;
            var script = document.createElement('script');
            script.src = "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A6e1b29bfb831e6868ca0460087b9bd7b138ea93171c356178daa1ba8f18be9dd&amp;width=auto25&amp;lang=ru_RU&amp;scroll=false";
            el.append(script);
        };
  });
/*   setTimeout(function(){
  ...
  function getYaMap(){
    var myMap = new ymaps.Map("map",{center: [55.019155, 82.911887],zoom: 15,
      controls: []});
