...
new _components_mail__WEBPACK_IMPORTED_MODULE_17__["default"]('hero-form').init(); // import './components/js';
...
class Mail {
  ...
  submit(event) {
    ...
    this.animate();
    this.postData(body).then(this.output.bind(this)).catch(this.errorData.bind(this));
  }
